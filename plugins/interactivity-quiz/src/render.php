...
<div class="paying-attention-frontend" style="background-color: <?php echo $attributes['bgColor'] ?>" data-wp-interactive="create-block" <?php echo wp_interactivity_data_wp_context($ourContext) ?>>
